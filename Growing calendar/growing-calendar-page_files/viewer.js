...
amp.get = function (assets, success, error, videoSort) {
    ...
    if(!isArray(assets)){
        ...
        jsonp(amp.getAssetURL(assets)+ '.js', assets.name, win(url), fail(url));
    }else{
        ...
        for (var i = 0; i < assLength; i++) {
            ...
            jsonp(url + '.js', assets[i].name, win(url), fail(url));
        }
    }
};
...
var jsonp =  function(url, name, success, error){
    ...
    var src = url + "?" + buildQueryString({deep:true, timestamp: movingCacheWindow(), arg: "'"+name+"'", func:"amp.jsonReturn"});
...
(function () {
    ...
    buildUrl = function(str, setOptions, caller) {
        ...
        var optionsArray = url[1] ? querystringToArray(url[1],function(parts, optionsObj){
            !parts[1] ? optionsObj["template"] = parts[0] : optionsObj[parts[0]] = parts[1];   // will this work in all cases?
        }) : [];
...
/**
 * @author: ccorbett
 * @author: Amplience.com
 * First Created: 15/11/13, 10:15
 */
...
this["amp"]["templates"]["template-fullscreen"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  buffer += "\n                <div>\n                    <span class=\"amp-centerer\"></span><img src=\"";
  ...
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.seoFriendlyName), {hash:{},inverse:self.noop,fn:self.program(2, program2, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "?"
    + escapeExpression(((stack1 = ((stack1 = (depth0 && depth0.templates)),stack1 == null || stack1 === false ? stack1 : stack1.imageZoom)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\" ";
  stack2 = helpers['if'].call(depth0, (depth0 && depth0.seoFriendlyName), {hash:{},inverse:self.noop,fn:self.program(4, program4, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += " class=\"amp-css-responsive\" data-amp-zoom-inline=\"{&quot;scaleSteps&quot;:true,&quot;events&quot;:{&quot;zoomIn&quot;:&quot;&quot;,&quot;zoomOut&quot;:&quot;&quot;,&quot;move&quot;:&quot;&quot;},&quot;pan&quot;:true,&quot;pinch&quot;:true}\">\n                </div>\n            ";
  return buffer;
  }
function program2(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "/";
  if (stack1 = helpers.seoFriendlyName) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.seoFriendlyName); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + ".jpg";
  return buffer;
  }
...
function program6(depth0,data) {
  ...
  var buffer = "", stack1, stack2;
  buffer += "\n                    <div class=\"amp-thumb-image-container\">\n                        <img src=\"";
  if (stack1 = helpers.src) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.src); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1);
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.seoFriendlyName), {hash:{},inverse:self.noop,fn:self.program(2, program2, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "?"
    + escapeExpression(((stack1 = ((stack1 = (depth0 && depth0.templates)),stack1 == null || stack1 === false ? stack1 : stack1.imageThumb)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\" ";
  stack2 = helpers['if'].call(depth0, (depth0 && depth0.seoFriendlyName), {hash:{},inverse:self.noop,fn:self.program(4, program4, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += " class=\"amp-main-img\">\n                    </div>\n                ";
  return buffer;
  }

  buffer += "<div class=\"template-fullscreen\">\n    <button type=\"button\" class=\"amp-icon amp-icon-zoom-close\" title=\"Close\" tabindex=\"0\" aria-label=\"close image carousel fullscreen view\">Close</button>\n    <div id=\"amp-carousel\" class=\"nav-horz\">\n        <div class=\"amp-viewer-main-container\">\n            <div class=\"amp-viewer-main\"\n                data-amp-carousel='{&quot;preload&quot;:false,&quot;loop&quot;:false,&quot;animate&quot;:false}'>\n            ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.items), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            </div>\n        </div>\n\n        <div class=\"amp-navigation-main-container amp-navigation-main \">\n            <div class=\"amp-navigation-main\"\n                data-amp-carousel='{&quot;onActivate&quot;:{&quot;select&quot;:true,&quot;goTo&quot;:false},&quot;preloadNext&quot;:false,&quot;dir&quot;:&quot;horz&quot;,&quot;responsive&quot;:false,&quot;loop&quot;:false,&quot;easing&quot;:&quot;ease-in-out&quot;,&quot;animDuration&quot;:600}'\n                data-amp-nav='{&quot;on&quot;:&quot;select&quot;,&quot;action&quot;:&quot;goTo&quot;,&quot;selector&quot;:&quot;.amp-viewer-main&quot;}'>\n                ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.items), {hash:{},inverse:self.noop,fn:self.program(6, program6, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            </div>\n            <button class=\"amp-prev amp-nav-prev amp-nav-button\" tabindex=\"0\" role=\"button\" aria-label=\"previous button for image carousel\">\n                <span class=\"amp-nav-button-link\"></span>\n            </button>\n            <button class=\"amp-next amp-nav-next amp-nav-button\" tabindex=\"0\" role=\"button\" aria-label=\"next button for image carousel\">\n                <span class=\"amp-nav-button-link\"></span>\n            </button>\n        </div>\n    </div>\n</div>";
  return buffer;
  });

this["amp"]["templates"]["template-mobile"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, functionType="function", escapeExpression=this.escapeExpression, self=this;
...
function program1(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "?"
    + escapeExpression(((stack1 = ((stack1 = (depth0 && depth0.templates)),stack1 == null || stack1 === false ? stack1 : stack1.imageMain)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\" ";
  stack2 = helpers['if'].call(depth0, (depth0 && depth0.seoFriendlyName), {hash:{},inverse:self.noop,fn:self.program(4, program4, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += " data-amp-zoom=\"{&quot;zoom&quot;:3,&quot;pan&quot;:true,&quot;cursor&quot;:{&quot;active&quot;:&quot;move&quot;},&quot;activate&quot;:{&quot;touch&quot;:&quot;pinch&quot;,&quot;mouse&quot;:&quot;up&quot;},&quot;transforms&quot;:&quot;"
    + escapeExpression(((stack1 = ((stack1 = (depth0 && depth0.templates)),stack1 == null || stack1 === false ? stack1 : stack1.imageZoom)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "&quot;}\" class=\"amp-main-img\" >\n                    </div>\n                ";
  return buffer;
  }
...
function program6(depth0,data) {
  ...
  buffer += "<div class=\"template-mobile\">\n    <div class=\"amp-viewer-nav-container\">\n        <div class=\"main\">\n             <div class=\"amp-viewer-nav-carousel border\"\n                data-amp-carousel='{&quot;gesture&quot;:{&quot;enabled&quot;:true,&quot;fingers&quot;:1},&quot;preloadNext&quot;:false,&quot;dir&quot;:&quot;horz&quot;,&quot;responsive&quot;:true,&quot;loop&quot;:false,&quot;height&quot;:298,&quot;width&quot;:298,&quot;easing&quot;:&quot;ease-out&quot;,&quot;animSpeed&quot;:500}'\n                data-amp-nav='{&quot;on&quot;:&quot;goTo&quot;,&quot;action&quot;:&quot;select&quot;,&quot;selector&quot;:&quot;.template-mobile .amp-viewer-selectors-carousel&quot;}'>\n\n                ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.items), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            </div>\n        </div>\n    </div>\n    <div class=\"amp-navigation-main-container amp-navigation-main\">\n        <div class=\"amp-navigation-main\"\n            data-amp-carousel='{&quot;preloadNext&quot;:false,&quot;dir&quot;:&quot;horz&quot;,&quot;responsive&quot;:true,&quot;loop&quot;:false,&quot;height&quot;:16,&quot;width&quot;:16,&quot;easing&quot;:&quot;ease-out&quot;,&quot;animSpeed&quot;:500}'\n            data-amp-nav='{&quot;on&quot;:&quot;select&quot;,&quot;action&quot;:&quot;goTo&quot;,&quot;selector&quot;:&quot;.template-mobile .amp-viewer-nav-carousel&quot;}'>\n            ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.items), {hash:{},inverse:self.noop,fn:self.program(6, program6, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
...
this["amp"]["templates"]["template-standard"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, functionType="function", escapeExpression=this.escapeExpression, self=this;
...
function program6(depth0,data) {
  ...
  stack2 = helpers['if'].call(depth0, (depth0 && depth0.seoFriendlyName), {hash:{},inverse:self.noop,fn:self.program(4, program4, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += " data-amp-zoom=\"{&quot;zoom&quot;:3,&quot;pan&quot;:true,&quot;cursor&quot;:{&quot;active&quot;:&quot;move&quot;},&quot;activate&quot;:{&quot;touch&quot;:&quot;pinch&quot;,&quot;mouse&quot;:&quot;disable&quot;},&quot;transforms&quot;:&quot;"
    + escapeExpression(((stack1 = ((stack1 = (depth0 && depth0.templates)),stack1 == null || stack1 === false ? stack1 : stack1.imageZoom)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "&quot;}\" class=\"amp-main-img\" >\n                    </div>\n                ";
  return buffer;
  }

  buffer += "<div class=\"template-standard\" >\n    <div class=\"nav-vert\">\n        <div class=\"amp-navigation-main-container amp-navigation-main\">\n            <div class='amp-navigation-main' data-amp-nav='{&quot;on&quot;:&quot;select&quot;,&quot;action&quot;:&quot;goTo&quot;,&quot;selector&quot;:&quot;.amp-viewer-main&quot;}'\n                 data-amp-carousel='{&quot;onActivate&quot;:{&quot;select&quot;:true,&quot;goTo&quot;:true},&quot;preloadNext&quot;:false,&quot;dir&quot;:&quot;vert&quot;,&quot;responsive&quot;:true,&quot;loop&quot;:false,&quot;easing&quot;:&quot;ease-in-out&quot;,&quot;animDuration&quot;:600}'\n                 >\n                ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.items), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            </div>\n            <button class=\"amp-prev amp-nav-prev amp-nav-button\" tabindex=\"0\" role=\"button\" aria-label=\"previous button for image carousel\">\n                <span class=\"amp-nav-button-link\"></span>\n            </button>\n            <button class=\"amp-next amp-nav-next amp-nav-button\" tabindex=\"0\" role=\"button\" aria-label=\"next button for image carousel\">\n                <span class=\"amp-nav-button-link\"></span>\n            </button>\n        </div>\n    </div>\n    <div class=\"amp-viewer-nav-container\">\n        <div class=\"main\">\n            <div class=\"amp-viewer-main\"\n                 data-amp-carousel='{&quot;onActivate&quot;:{&quot;select&quot;:true,&quot;goTo&quot;:true},&quot;gesture&quot;:{&quot;enabled&quot;:true,&quot;fingers&quot;:1},&quot;preloadNext&quot;:false,&quot;dir&quot;:&quot;horz&quot;,&quot;responsive&quot;:true,&quot;loop&quot;:false,&quot;height&quot;:298,&quot;width&quot;:298,&quot;easing&quot;:&quot;ease-out&quot;,&quot;animSpeed&quot;:500}'\n                 >\n\n                ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.items), {hash:{},inverse:self.noop,fn:self.program(6, program6, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            </div>\n        </div>\n        <button class=\"amp-icon amp-icon-zoom-in\" type=\"button\" tabindex=\"0\" title=\"Zoom\" aria-label=\"open image carousel fullscreen view\">Zoom</button>\n    </div>\n\n    <div class=\"nav-horz\">\n        <div class=\"amp-nav-mobile amp-navigation-main-container amp-navigation-main\">\n            <div class=\"amp-navigation-main\"\n                 data-amp-carousel='{&quot;onActivate&quot;:{&quot;select&quot;:true,&quot;goTo&quot;:true},&quot;preloadNext&quot;:false,&quot;dir&quot;:&quot;horz&quot;,&quot;responsive&quot;:false,&quot;loop&quot;:false,&quot;easing&quot;:&quot;ease-in-out&quot;,&quot;animDuration&quot;:600}'\n                 data-amp-nav='{&quot;on&quot;:&quot;select&quot;,&quot;action&quot;:&quot;goTo&quot;,&quot;selector&quot;:&quot;.amp-viewer-main&quot;}'>\n                ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.items), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            </div>\n            <button class=\"amp-prev amp-nav-prev amp-nav-button\" tabindex=\"0\" role=\"button\" aria-label=\"previous button for image carousel\">\n                <span class=\"amp-nav-button-link\"></span>\n            </button>\n            <button class=\"amp-next amp-nav-next amp-nav-button\" tabindex=\"0\" role=\"button\" aria-label=\"next button for image carousel\">\n                <span class=\"amp-nav-button-link\"></span>\n            </button>\n        </div>\n    </div>\n</div>\n";
  return buffer;
...
this["amp"]["templates"]["mainView_evt"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
function program3(depth0,data) {
  ...
  buffer += "\n\n       <div id=\"navContainer\">\n            <div class=\"previousThumbnail prev fa fa-chevron-up\"></div>\n            <ul id=\"nav\">\n                ";
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            </ul>\n\n            <div class=\"nextThumbnail prev fa fa-chevron-down\"></div>\n        </div>\n\n     <div class=\"prev fa fa-chevron-circle-right\"></div>\n        <ul id=\"main\">\n            ";
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n        </ul>\n        <div class=\"next fa fa-chevron-circle-left\"></div>\n\n\n    ";
  return buffer;
  });
...
(function () {
    ...
    var createViewer = function (settings) {
        var options = ['set', 'account', 'path', 'target', 'assetsPath', 'setList', 'mobile'];
        // Defaults Variables for player
        var defaults = {
            set: '',
            setList: '',
            account: 'wgc',
            path: "https://i1-orig.adis.ws/",
            assetsPath: "./dist/assets/",
            analytics: null,
            mobile: false,
            navigationOrientation: 'auto',
            seoFriendlyName:''
        };
        // Creating the settings for the player from the options
        for (var i in options) {
            var o = options[i];
            if(typeof settings[o] == 'undefined'){
                if (typeof defaults[o] == 'undefined') {
                    if(console && console.warn)
                        console.warn("'"+o+"' needs to be in the viewer settings");
                } else {
                    settings[o] = defaults[o];
                }
            }
        }
        var node = settings.target;
        this.info = {};
        var $node = $(node);

        var standard = "template-standard";
        var full = "template-fullscreen";
        var mobile = "template-mobile";
        ...
        amp.init({
            ...
            di_basepath: settings.path
        });

        if(settings.analytics) {
            amp.stats.bind(settings.analytics);
        }


        if(settings.setList) {
            amp.get(settings.setList,function(data){
                var makeSet = {};
                makeSet.items = [];

                //Need to put in order
                for(var i=0; i < settings.setList.length; i++){
                    var img = data[settings.setList[i].name];
                    if(!img)
                        continue; // load error or timeout

                    // Cater for sets
                    if( img.items && img.items.length){
                        // We have a set
                        img['set'] = {"name":img.name,"type":"list","items":img.items};
                        delete img.items;
                    } else {
                        if(settings.setList[i].template) {
                            img.template = '&'+settings.setList[i].template;
                        } else {
                            img.template =  '';
                        }
                    }
                    img['src'] = img['url'];
                    makeSet.items.push(img);
                }
                amp.setData = makeSet;
                build(amp.setData);
            }, null, settings.videoOrder);
        } else if(settings.set) {
            amp.get([{"name":settings.set,"type":"s"}],function(data){
                amp.setData = data[settings.set];
                build(amp.setData);
            },null,settings.videoOrder);
        }
        ...
        function build(data) {
            $node.html('');
            data.assetsPath = settings.assetsPath;
            for(var i in data.items){
                data.items[i].ind = i;
                data.items[i].src = data.items[i].src.replace('http:', '');
                //console.log(data.items[i]);
                data.items[i].templates = settings.templates;
                data.items[i].seoFriendlyName = settings.seoFriendlyName;
                data.navOrien = settings.navigationOrientation;
            }
            if( canFull ){
                buildHTML(data,full);
            } else {
                // storing the fullscreen template data for later!!!
                window.amp.fsdata = {'data':data,'full':full};


            }
            buildHTML(data, settings.mobile ? mobile : standard);
        }

    function buildHTML(data,template) {


        
        if(data){
            var dom = amp.templates["mainView_evt"](data);
            $node.append(dom);
        }

        var topElmSelector = $node[0].getAttribute("data-topWrapperElm");
        if(!topElmSelector) topElmSelector = "";
        var targNavId = "#nav";
        var targMainId = "#main";
        if(topElmSelector == "#overlay"){
            targNavId = "#overlayNav";
            targMainId = "#overlayMain";
            $(topElmSelector+' #nav')[0].id = "overlayNav";
            $(topElmSelector+' #main')[0].id = "overlayMain";

        }

        /*
        var imgTarg = $('#navContainer');
        if(data){//} || imgTarg.length && !imgTarg[0].offsetHeight){
            setTimeout(
                function(){
                    buildHTML(false,template)
                },5000
        ...
        */
        ...
        $(targNavId+' img', $node).ampImage({'preload':'visible'});

/*
        $('#main img').ampZoom({
            create:function(){
                $('#main li:first img').ampZoom('visible',true);
            },
            activate:{mouse:'over'},
            target:'#target',
            preload:{image:'visible',zoomed:'visible'},
            zoomedIn:function(){
                $('body').addClass('zoomed-in');
                $('#target').width(0).animate({'width':306});
            },
            zoomedOut:function(){
...
*/
        ...
        $(targMainId+' img', $node).ampZoom({
            create:function(){
                $(targMainId+' li:first img', $node).ampZoom('visible',true);
            },
            activate:{mouse:'over'},
            target:topElmSelector+' #target',
            preload:{image:'visible',zoomed:'visible'},
            zoomedIn:function(){
                $('body', $node).addClass('zoomed-in');
                $('#target', $node).width(0).animate({'width':306});
            },
            zoomedOut:function(){
                $('body', $node).removeClass('zoomed-in');
            }
        });

        
        $(targNavId).ampCarousel({
            width:68,
            height:356,
            responsive:true,
            onActivate: {select:true,goTo:false},
            dir:'vert',
            loop:false,
            change:function(a,b){
                b.canNext?$(targNavId+' .nextThumbnail', $node).removeClass('disabled'):$(targNavId+' .nextThumbnail', $node).addClass('disabled');
                b.canPrev?$(targNavId+' .previousThumbnail', $node).removeClass('disabled'):$(targNavId+' .previousThumbnail', $node).addClass('disabled');
            },
        ...
        $(targMainId, $node).ampStack({
            width:306,
            height:406,
            responsive:true
        });
        $(targNavId+' .nextThumbnail', $node).click(function(){
            $(targNavId, $node).ampCarousel('next');
        });
        $(targNavId+' .previousThumbnail', $node).click(function(){
            $(targNavId, $node).ampCarousel('prev');
        });

    /*
            $('#main .next').bind('click',function(e) {
                $('#main .list').ampCarousel('next');
            });
            $('#main .prev').bind('click',function(e) {
                $('#main .list').ampCarousel('prev');
            });*/
        $(targNavId, $node).ampNav({on:'select','action':'goTo',selector:targMainId});



            var counter = 0;
            var targs = $(targNavId+" li", $node);
            var fred = function(){
                var dir = 1;

                if(this.className.search("next") > -1){
                    dir = -1;
                } else {
                ...
                counter += dir;
                if(counter < 0) counter = targs.length-1;
                if(counter >= targs.length) counter = 0;
                $(targs[counter]).mouseup();
                $(targs[counter]).trigger("touchend");
            };


            if(targs.length > 1){
                $('.fa-chevron-circle-left', $node).on("click", fred);
                $('.fa-chevron-circle-left', $node).css("display", "");
                $('.fa-chevron-circle-right', $node).on("click", fred);
                $('.fa-chevron-circle-right', $node).css("display", "");
            } else {
                $('.fa-chevron-circle-left', $node).css("display", "none");
                $('.fa-chevron-circle-right', $node).css("display", "none");
            }
        ...
        return;
            ...
            var template = amp.templates[template];
            var dom = $(template(data));
            dom.disableSelection();

            // Actions
            dom.find('.amp-nav-next').on('click',next);
            dom.find('.amp-nav-prev').on('click',prev);

            $node.addClass('amp');
            $node.append(dom);
            if (currentTemplate == "template-fullscreen"){
                $('body').append(dom);
            } else {
                $node.append(dom);
            }
            ...
            $('.amp-navigation-main .amp-slide').on('click',selectNav);
            var skipper = 0;
            amp.stats.bind({'type':'carousel','event':'change','cb':function(a,b,c,d){
                if(skipper == 0) {
                    skipper = 1;
                    amp.selectedIndex = d.index;
                    var s = $('.template-standard')[0],
                        f = $('.template-fullscreen')[0];
                    $('[data-amp-carousel]').ampCarousel('select', amp.selectedIndex);
                    idx = d.index;
                    setTimeout(function() { skipper = 0 },200)
                }
                hidenav();
            }});


            if(!amp.isTouchDevice()){
                $('.amp-nav-button').addClass("notouch");
            }


            $(".amp-icon-zoom-in").on('click', function() {
                amp.viewer_fullscreen(true);
            });

            $(".amp-icon-zoom-close").on('click',function(){
                setTimeout(function(){amp.viewer_fullscreen(false);},100)

            });

            $('.amp-root-next').on('click',function(){
                next();
            });
            $('.amp-root-prev').on('click',function(){
                prev();
            });

                var length = $(".amp-navigation-main .amp-navigation-main img").length;
                if(length <= 6){
                    $(".amp-nav-button").remove();
                    $(".amp-navigation-main").css({'margin-top':'0', 'margin-bottom':'0'})
                }
            ...
            var focusPrev = false;
            var focusNext = false;
            $('.amp-nav-prev').focusin(function() {
                focusPrev = true;
            });
            $('.amp-nav-prev').focusout(function() {
                focusPrev = false;
            });
            $('.amp-nav-next').focusin(function() {
                focusNext = true;
            });
            $('.amp-nav-next').focusout(function() {
                focusNext = false;
            });
            $("#amp-container, .template-fullscreen").focusin(function() {
                focus = true;
            });
            $("#amp-container, .template-fullscreen").focusout(function() {
                focus = false;
            });
            ...
            window.onkeyup = function(e) {
                ...
                if (focus && key == 37 || focus && key == 38) {
                    amp.selectedIndex = amp.selectedIndex - 1;
                    if(amp.selectedIndex < 1)
                        amp.selectedIndex = 1;

                    $(".amp-carousel").ampCarousel('goTo', amp.selectedIndex);
                }
                if (focus && key == 39 || focus && key == 40) {
                    amp.selectedIndex = amp.selectedIndex + 1;
                    if(amp.selectedIndex > amp.totalCount)
                        amp.selectedIndex = amp.totalCount;
                    $(".amp-carousel").ampCarousel('goTo', amp.selectedIndex);
                }
                if (focus && key == 13 || focus && key == 32) {
                    if(focusNext) {
                        next();
                    }
                    if(focusPrev) {
                ...
                if (key == 27) {
                    amp.viewer_fullscreen(false);
                }
                hidenav();
            }
            var w = $(".template-standard .amp-anim-container").width() - 10;
            amp.isMobileView = ($(window).width() < 70);
            $(".template-standard .nav-vert .amp-thumb-image-container").css({'height':  w+"px", 'width':  w+"px" });
            $(".template-standard .nav-vert .amp-navigation-main-container").height($(".template-standard .amp-viewer-nav-container").height()+'px');
            $(window).resize(function() {
                w = $(".template-standard .amp-anim-container").width() - 10;
                amp.isMobileView = ($(window).width() < 470);
                $(".template-standard .nav-vert .amp-thumb-image-container").css({'height':  w+"px", 'width':  w+"px" });
                $(".template-standard .nav-vert .amp-navigation-main-container").height($(".template-standard .amp-viewer-nav-container").height()+'px');
            });

            amp.totalCount = $(".template-standard .amp-viewer-main div.amp-slide").length;
        }



        var goToIdx;
        var fullscreen = amp.viewer_fullscreen = function(show) {
            var currentTemplate = !show ? standard : full;
            if(!canFull){
                // Need to build the full screen
                buildHTML(window.amp.fsdata.data, window.amp.fsdata.full);
            }

            canFull = true;
            $('.' + full).css('visibility',show?'visible':'hidden');
            $('.' + standard).css('visibility',!show?'visible':'hidden');

            amp.isFull = show;

            $('.' + currentTemplate + ' [data-amp-stack]').ampStack('goTo', amp.selectedIndex);
            $('.template-fullscreen .amp-navigation-main.amp-carousel').ampCarousel('goTo',goToIdx);
            $('.template-fullscreen .amp-stack').ampStack('goTo',goToIdx);
            $('.template-fullscreen [data-amp-carousel]').ampCarousel('select', amp.selectedIndex);

            // Hide Scrollbar on Full Screen
            $("body").css("overflow", show ? "hidden" : "auto");
         };

        var idx = 1;
        var doNavigation = function(dir){
            // Find out which template we are using
            var template = !amp.isFull ? "." + standard : "." + full;
            var isTablet = ($(template).width() <= 470);
            var step = 6;

            var localCarousel = $(""+template+" .amp-navigation-main-container .amp-navigation-main");
            if(!amp.isFull){
                if( isTablet ){
                    localCarousel = $(""+template+" .amp-navigation-main-container .amp-navigation-main");
                } else{
                    localCarousel = $(""+template+" .amp-navigation-main-container .amp-navigation-main");
                }
            }
            var length = $('.' + standard + ' .amp-navigation-main .amp-navigation-main img').length;

            if( settings.mobile){
                length = $('.template-mobile .amp-navigation-main .amp-navigation-main img').length;
                localCarousel = $(".template-mobile .amp-navigation-main-container .amp-navigation-main");
                if(dir == 1){
                    idx = idx + step;
                } else {
                    idx = idx - step;
                ...
                localCarousel.ampCarousel('goTo', idx );
            } else {
                if(dir == 1){
                    idx = idx + step;
                } else {
        ...
        function hidenav() {
            if(amp.isMobileView) {
                amp.orientation = 'horz';
            } else {
                amp.orientation = 'vert';
            }
            var l = $('.template-standard .nav-vert .amp-navigation-main-container .amp-slide').length - 1;
            if($('.template-standard .nav-'+amp.orientation+' .amp-navigation-main-container .amp-slide:eq(0)').hasClass('amp-visible')) {
                $(".amp-prev").hide();
            } else {
                $(".amp-prev").show();
                /*console.log($('.template-standard .nav-vert .amp-navigation-main-container .amp-anim-container').attr('style'));
                var t = $('.template-standard .nav-vert .amp-navigation-main-container .amp-anim-container').attr('style').split(',');
                if(t[1]) {

                    t[1] = parseInt(t[1]) + 140;
                    var s = t[0] + ', ' + t[1]+ 'px , ' + t[2];
                    console.log(s);
                    $('.template-standard .nav-vert .amp-navigation-main-container .amp-anim-container').attr('style', s);
                }*/
            }

            if($('.template-standard .nav-'+amp.orientation+' .amp-navigation-main-container .amp-slide:eq('+l+')').hasClass('amp-visible')) {
                $(".amp-next").hide();
            } else {
                $(".amp-next").show();
            }
        ...
        function selectNav(e) {
            ...
            amp.selectedIndex = !amp.isFull ? $(".template-standard div.amp-slide").index($(this)) + 1 : $(".template-fullscreen .amp-navigation-main div.amp-slide").index($(this)) + 1;
            $('[data-amp-carousel]').ampCarousel('select',amp.selectedIndex);
            hidenav();
        }
    };
    ...
    amp.selectedIndex = 1;
    amp.isFull = false;
    amp.isMobileView = false;
    amp.createViewer = createViewer;
    amp.isTouchDevice = function() {
